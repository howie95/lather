    ...
    <div id="app">
        ...
        <span @click="smoothTop" class="totop" v-if="!istop">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                ...
                <g>
                    <g>
                        <path style="fill:#6993b5;" d="M53,4.783v44.435C53,51.306,51.306,53,49.217,53H4.783C2.694,53,1,51.306,1,49.217V4.783
                            C1,2.694,2.694,1,4.783,1h44.435C51.306,1,53,2.694,53,4.783z"/>
                        <path style="fill:#6993b5;" d="M49.217,54H4.783C2.146,54,0,51.854,0,49.217V4.782C0,2.146,2.146,0,4.783,0h44.435
